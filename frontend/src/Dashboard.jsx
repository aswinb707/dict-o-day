      ...
      .then(learnedRes => {
        ...
        if (learnedRes.data) {
          mappedLearned = learnedRes.data.map(p => ({
            ...
            status: p.status,
            dateLearned: p.masteredAt ? p.masteredAt.split("T")[0] : (p.lastReviewedAt ? p.lastReviewedAt.split("T")[0] : (p.firstSeenAt ? p.firstSeenAt.split("T")[0] : new Date().toISOString().split("T")[0])),
